...
SECRET_KEY = os.environ.get('API_SECRET_KEY', default='!rgck%&1&ba(jaa=_*99nrmoo)42!-eul@60v00+v%vx8fp=b)')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = int(os.environ.get('API_DEBUG', default=0))

ALLOWED_HOSTS = [os.environ.get('API_ALLOWED_HOSTS', '127.0.0.1'), 'localhost', '192.168.20.5']
